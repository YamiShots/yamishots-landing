      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-5">
          {truths.map((truth) => (
            <div
              key={truth.number}
              className="bg-zinc-900 border border-white/5 rounded-2xl p-7 hover:border-white/10 transition-colors duration-300"
            >
              <span className="text-amber-500/40 text-xs font-bold tracking-widest">
                {truth.number}
              </span>
