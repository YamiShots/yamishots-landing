    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="border-t border-white/5 py-24 px-6 text-center">
        ...
        <a
          ...
          className="inline-flex items-center gap-3 bg-amber-500 hover:bg-amber-400 text-black font-bold px-8 py-4 rounded-xl text-base transition-all duration-200 hover:scale-[1.02] shadow-lg shadow-amber-500/15"
        >
